...
> **NOTE 1** Voor een goede gerbuikers ervaring voor zowel bezoekers als medewerkers is het belangrijk dat de API snel is, bij voorkeur rond de 100 Miliseconde (1/10 van sen seconde). API calls van meer dan 200 Miliseconde moeten worden vermeden. API calls van meer dan een seconde zijn niet toegestaan en reden om PR af te keuren
